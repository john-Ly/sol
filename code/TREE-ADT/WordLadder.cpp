...
computeAdjacentWordsMedium( const vector<string> & words )
{
    ...
    {
        const vector<string> & groupsWords = entry.second;  // avoid copy
...
//
// @TODO How to caculate the time complexity (N log N)
map<string,vector<string>>
